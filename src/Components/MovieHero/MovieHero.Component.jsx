        ...
        <>
            <div>
                ...
                <div className='relative hidden w-full lg:block' style={{ height: '30rem' }}>
                    <div className='absolute z-10 w-full h-full' style={{ backgroundImage: "linear-gradient(90deg, rgb(34,34,34) 24.95%, rgba(34,34,34,0.90) 38.3%, rgba(34,34,34,0.60) 58.3%, rgba(34,34,34,0.04) 100%)", }} />
                    ...
                    <img src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`} alt="backdrop poster" className='ml-12 pl-12 w-full h-full object-fit object-center' />
                </div>
            </div>
        </>
    )

        ...
        <>
            <Link to={`/movie/${props.id}`}>
                <div className='flex flex-col items-start gap-2 px-1 md:px-3'>
                    ...
                    {/* <p className={`text-lg font-bold ${props.isDark ? "text-white" : "text-gray-700"}`}></p> */}
...
const PlayPoster = (props) => {
    return (
        <>
            <a href='https://in.bookmyshow.com/events/vipul-goyal-live/ET00321860' target="_blank" rel='noreferrer'>
                <div className='flex flex-col items-start gap-2 px-1 md:px-3'>
                    <div className='h-40 md:h-80'>
